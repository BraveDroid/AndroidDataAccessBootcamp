...
public class ExternalFileHelperTest {
    ...
    public void tearDown() {
        ...
        SUT.deleteAllExternalPublicFiles();
    ...
    @Test
    public void deletePublicExternalFile() {
        SUT.createPublicExternalFile2("myFile1", "Hello Every body :)!!");
        SUT.createPublicExternalFile2("myFile2", "Hello Every body :)!!");
        SUT.createPublicExternalFile2("myFile3", "Hello Every body :)!!");

        SUT.deletePublicExternalFile("myFile2");
        String[] listNameFiles = SUT.listNamePublicExternalFiles();
        String[] expectedListNameFiles = {"myFile1", "myFile3"};
        assertThat(listNameFiles, is(equalTo(expectedListNameFiles)));
    }
    ...
    @Test
    public void readPublicExternalFileContent1Test() {
        createSamplePublicFile();
        String result = SUT.readPublicExternalFileContent("myFile");
        String expected = "Hello Every body :)!!                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ";
        assertThat(result, is(equalTo(expected)));
    }

    @Test
    public void readPublicExternalFileContent2Test() {
        createSamplePublicFile();
        String result = SUT.readPublicExternalFileContent2("myFile");
        String expected = "Hello Every body :)!!                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           ";
        assertThat(result, is(equalTo(expected)));
    }

    @Test
    public void writeInPublicExternalFile2Test() {
        SUT.createPublicExternalFile2("myFile", "Hello Every body :)!!");
    ...
    @Test
    public void readPublicExternalFileContent3Test() {
        createSamplePublicFile();
        String result = SUT.readPublicExternalFileContent3("myFile");
        String expected = "Hello Every body :)!!";
        assertThat(result, is(equalTo(expected)));
    }
}
